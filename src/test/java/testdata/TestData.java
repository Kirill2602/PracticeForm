...
public class TestData {
    ...
    private String firstName = faker.name().firstName(),
            ...
            gender = genderList.get(random.nextInt(0, genderList.size())),
            subject = subjectsList.get(random.nextInt(0, subjectsList.size())),
            hobby = hobbyList.get(random.nextInt(0, hobbyList.size())),
